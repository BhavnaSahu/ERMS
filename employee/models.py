...
class EmployeeDetail(models.Model):
    ...
    empdept = models.CharField(max_length=40,null=True)
...
class EmployeeEducation(models.Model):
    ...
    percentagepg = models.CharField(max_length=3,null=True)
    ...
    percentagegra = models.CharField(max_length=3, null=True)
    ...
    percentagessc = models.CharField(max_length=3, null=True)
    ...
    percentagehsc = models.CharField(max_length=3, null=True)
